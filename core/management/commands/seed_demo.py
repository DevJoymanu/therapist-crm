...
from notes.models import ScoreEntry, SessionNote
from notes.services import criteria_for
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        patients = [
            {"first_name": "Maya", "last_name": "Singh", "email": "maya@example.com", "phone": "+1 555 0101", "previous_treatment": "Generalized anxiety; no current medication changes."},
            {"first_name": "Jonah", "last_name": "Reed", "email": "jonah@example.com", "phone": "+1 555 0102", "previous_treatment": "Depression history; safety plan reviewed."},
            {"first_name": "Elena", "last_name": "Morales", "email": "elena@example.com", "phone": "+1 555 0103", "previous_treatment": "Work stress and sleep disruption."},
        ]
        ...
        for index, data in enumerate(patients):
            ...
            Appointment.objects.get_or_create(
                ...
                defaults={"ends_at": starts_at + timedelta(minutes=50), "location": "Room 2", "reminder_email": True},
            )
            for week in range(3):
                ...
                for criterion in criteria:
                    ...
                    ScoreEntry.objects.get_or_create(
                        session=session, criterion=criterion, defaults={"value": value},
                    )
