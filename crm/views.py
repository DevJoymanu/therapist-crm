...
class CalendarView(TherapistRequiredMixin, TemplateView):
        ...
        for week in month_weeks:
            ...
            for day in week:
                ...
                for a in appts[:3]:
                    mini_items.append({
                        "kind": "appointment",
                        "label": f"{a.starts_at.strftime('%H:%M')} {a.patient.first_name}",
                        "status": a.status,
                    })
...
class CalendarDayView(TherapistRequiredMixin, View):
    def get(self, request, date_str):
        ...
        return render(
            request,
            "crm/partials/calendar_day_panel.html",
            {
                "day": day,
